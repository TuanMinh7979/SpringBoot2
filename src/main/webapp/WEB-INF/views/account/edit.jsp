...
<body>
<form id="myForm" action="/account/add" method="post">
		username <input type="text" id="e1" name="userName" value="${account.userName}"> <br />
		fullname <input type="text" id="e2" name="fullName" value="${account.fullName}"><br />
		password <input type="password" id="e3" name="password" value="${account.password}"> <br />
		gender<input type="radio" id="e6" name="gender" value=1> Male
		<input type="radio" value=0 name="gender" id="e5"> FeMale <br />
		dob :<input type="date" id="e4" name="birthday" value="${account.birthday}"> <br /> <input
